//
//  KFAMusicPlayerRequestManager.h
//  KFAHotchpotch
//
...
@protocol KFAMusicPlayerRequestDelegate  <NSObject>
...
@interface KFAMusicPlayerRequestManager : NSObject

+ (instancetype)requestWithUrl:(NSURL *)url;
- (instancetype)initWithUrl:(NSURL *)url;

@property (nonatomic, weak) id<KFAMusicPlayerRequestDelegate> delegate;
