...
@implementation KFAReadUtilites
...
+ (NSMutableArray *)parseOPF:(NSString *)opfPath {
    ...
    for (CXMLElement* element in itemRefsArray){
        ...
        KFAChapterModel *model = [KFAChapterModel chapterWithEpub:path title:[titleDictionary objectForKey:chapHref] imagePath:[path stringByDeletingLastPathComponent]];
        [chapters addObject:model];
